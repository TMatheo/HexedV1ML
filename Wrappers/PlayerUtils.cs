...
namespace LUXED.Wrappers
{
    internal static class PlayerUtils
    {
        ...
        public static short GetPing(this PhotonView instance)
        {
            return (short)instance.prop_Int32_0;
        }
        ...
        public static int GetFrames(this PhotonView Instance)
        {
            return Instance.prop_Int32_1 == 0 ? 0 : 1000 / Instance.prop_Int32_1;
        }
        ...
        public static float GetQuality(this PhotonView Instance)
        {
