...
namespace LUXED.Wrappers
{
    internal static class PlayerSimplifier
    {
        ...
        public static APIUser GetAPIUser(this PhotonView Instance)
        {
            return Instance.prop_Player_0.GetPlayer()?.GetAPIUser();
        }
        ...
        public static Player GetPlayer(this PhotonView Instance)
        {
        ...
        //VRCPlayer
        public static VRCPlayer GetVRCPlayer(this PhotonView Instance)
        {
            return Instance.prop_Player_0.field_Public_Player_0._vrcplayer;
        }
        ...
        public static VRCPlayerApi GetVRCPlayerApi(this PhotonView Instance)
        {
            return Instance.prop_Player_0.GetPlayer()?.GetVRCPlayerApi();
        }

        //PhotonPlayer
        public static Photon.Realtime.Player GetPhotonPlayer(this PhotonView Instance)
        {
            return Instance.prop_Player_0.GetPlayer()?.GetPhotonPlayer();
        }
        ...
        public static PhotonView GetPlayerNet(this VRCPlayer Instance)
        {
        ...
        public static string UserID(this PhotonView Instance)
        {
            try
            {
                return Instance.GetPlayer()?.UserID();
