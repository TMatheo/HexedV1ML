...
namespace LUXED.UIApi
{
    internal static class PopupAPI
    {
        ...
        public static void HudMessage(string Text, Sprite icon = null)
        {
            ...
            activeCarousel.Method_Private_Void_LocalizableString_Sprite_Single_0(localizableString, icon);
        }
        public static void HudToast(string content, string description = null, Sprite icon = null, float duration = 5f)
        {
            ...
            VRCUiManager.field_Private_Static_VRCUiManager_0.field_Private_HudController_0.notification.Method_Public_Void_Sprite_LocalizableString_LocalizableString_Single_Object1PublicTBoTUnique_1_Boolean_0(icon, message, desc, duration);
        }
