...
namespace LUXED.Core
{
    internal class InternalSettings
    {
        ...
        public static Dictionary<int, long> ActorsWithLastActiveTime = new Dictionary<int, long>();
        public static Dictionary<string, DateTime> InstanceHistory = new Dictionary<string, DateTime>();
