        ...
        public static void UpdateFingers(HandProcessor fingerController, bool LeftHand, bool RightHand)
        {
            ...
            for (int j = 0; j < 5; j++)
            {
                if (LeftHand)
                {
                    ...
                    fingerController.field_Private_ArrayOf_Single_0[j] = 1f - currentBend;
                    fingerController.field_Private_ArrayOf_Single_1[j] = currentSpread;
                }
                ...
                if (RightHand)
                {
                    ...
                    fingerController.field_Private_ArrayOf_Single_0[j + 5] = 1f - currentBend;
                    fingerController.field_Private_ArrayOf_Single_1[j + 5] = currentSpread;
                }
            }
        }
