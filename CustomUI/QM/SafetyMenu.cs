...
namespace LUXED.CustomUI.QM
{
    internal class SafetyMenu
    {
        ...
        {
            SafetyPage = new QMMenuPage("Safety");

            QMSingleButton OpenMenu = new QMSingleButton(MainMenu.ClientPage, 1, 0, "Safety", SafetyPage.OpenMe, "Safety Options", ButtonAPI.ButtonSize.Default, UnityUtils.GetSprite("Safety"));
