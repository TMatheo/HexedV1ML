...
namespace LUXED.CustomUI.QM
{
    internal class BotMenu
    {
        ...
        {
            BotsPage = new QMMenuPage("Bots");

            QMSingleButton OpenMenu = new QMSingleButton(MainMenu.ClientPage, 4, 0, "Bots", BotsPage.OpenMe, "Bot Options", ButtonAPI.ButtonSize.Default, UnityUtils.GetSprite("Bots"));
