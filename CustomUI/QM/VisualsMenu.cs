...
namespace LUXED.CustomUI.QM
{
    internal class VisualsMenu
    {
        ...
        {
            VisualsPage = new QMMenuPage("Visuals");

            QMSingleButton OpenMenu = new QMSingleButton(MainMenu.ClientPage, 3, 1, "Visuals", VisualsPage.OpenMe, "Visual Options", ButtonAPI.ButtonSize.Default, UnityUtils.GetSprite("Visuals"));
