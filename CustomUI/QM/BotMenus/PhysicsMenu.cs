...
namespace LUXED.CustomUI.QM.BotMenus
{
    internal class PhysicsMenu
    {
        ...
        {
            PhysicsPage = new QMMenuPage("Bot Physics");

            QMSingleButton OpenMenu = new QMSingleButton(BotMenu.BotsPage, 2, 1.5f, "Physics", PhysicsPage.OpenMe, "Bot Physic Options", ButtonAPI.ButtonSize.Default, UnityUtils.GetSprite("Physics"));
            ...
            QMScrollButton MotionScroll = new QMScrollButton(PhysicsPage, 1, 3, "Motion \nFiles", "Motion Files", ButtonAPI.ButtonSize.Default, UnityUtils.GetSprite("Options"));
            QMScrollButton DirScroll = new QMScrollButton(PhysicsPage, 1, 3, "Motion Options", "Motion File Options");
