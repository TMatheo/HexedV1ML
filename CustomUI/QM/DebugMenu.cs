...
namespace LUXED.CustomUI.QM
{
    internal class DebugMenu
    {
        ...
        {
            DebugPage = new QMMenuPage("Debug");

            QMSingleButton OpenMenu = new QMSingleButton(MainMenu.ClientPage, 2, 1, "Debug", DebugPage.OpenMe, "Debug Options", ButtonAPI.ButtonSize.Default, UnityUtils.GetSprite("Debug"));
            ...
            new QMToggleButton(DebugPage, 4, 1, "Debug\nMode", delegate
            {
                Main.IsDebug = true;
            }, delegate
            {
                Main.IsDebug = false;
            }, "Debug Hook/Update/PlayerModule etc.");
        }
    }
}
