...
namespace LUXED.CustomUI.QM
{
    internal class SpoofMenu
    {
        ...
        {
            SpoofPage = new QMMenuPage("Spoof");

            QMSingleButton OpenMenu = new QMSingleButton(MainMenu.ClientPage, 2, 2, "Spoof", SpoofPage.OpenMe, "Spoof Options", ButtonAPI.ButtonSize.Default, UnityUtils.GetSprite("Spoof"));

            QMSelectButton UdonSPoofMenu = new QMSelectButton(SpoofPage, 1, 0, "Udon \nSpoof", "Spoof your Udon name", InternalSettings.UdonSpoof, ConfigManager.Ini.GetInt("Toggles", "UdonSpoofMode"));
