...
namespace LUXED.CustomUI.QM
{
    internal class PhysicsMenu
    {
        ...
        {
            PhysicsPage = new QMMenuPage("Physics");

            QMSingleButton OpenMenu = new QMSingleButton(MainMenu.ClientPage, 3, 0, "Physics", PhysicsPage.OpenMe, "Physics Options", ButtonAPI.ButtonSize.Default, UnityUtils.GetSprite("Physics"));
            ...
            new QMSlider(PhysicsPage, 480f, "Flight Speed","Adjust flight speed.",(value, slider) =>
            {
