...
namespace LUXED.CustomUI
{
    internal class UIQuickChanges
    {
        ...
        private static void ChangeHeader()
        {
            ...
            if (TitleText != null) TitleText.GetComponent<TextMeshProUGUI>().text = "             愛 M E L E X E D 毒";
            else HDLogger.LogError("Failed to find Text_Title");
        }
        ...
        private static void ChangeDebugPanel()
        {
            ...
            else HDLogger.LogError("Failed to find DebugInfoPanelBackground");
            ...
            else HDLogger.LogError("Failed to find DebugPanel");
        }
        private static void RemoveAds()
        {
            ...
            else HDLogger.LogError("Failed to find PanelInfo");
            ...
            else HDLogger.LogError("Failed to find inverted_sphere");
            ...
            else HDLogger.LogError("Failed to find Character");
            ...
            else HDLogger.LogError("Failed to find Dialog Buble");
            ...
            else HDLogger.LogError("Failed to find VRC+_Banners");
            ...
            else HDLogger.LogError("Failed to find Carousel_Banners");

            Transform MainCarouselBanner = MenuHelper.MainMenu.transform.Find("Container/MMParent/HeaderOffset/Menu_Dashboard/ScrollRect_MM/Viewport/Content/Panel/Carousel_Banners");
            if (MainCarouselBanner != null)
            {
                MainCarouselBanner.localScale = Vector3.zero;
                MainCarouselBanner.gameObject.SetActive(false);
            }
            else HDLogger.LogError("Failed to find Main Carousel_Banners");

            Transform AvatarBannerUpsell = MenuHelper.MainMenu.transform.Find("Container/MMParent/HeaderOffset/Menu_Avatars/Menu_MM_DynamicSidePanel/Panel_SectionList/ScrollRect_Navigation_Container/ScrollRect_Content/Viewport/VerticalLayoutGroup/VRC+ Upsell");
            if (AvatarBannerUpsell != null)
            {
                AvatarBannerUpsell.localScale = Vector3.zero;
                AvatarBannerUpsell.gameObject.SetActive(false);
            }
            else HDLogger.LogError("Failed to find VRC+ Upsell");

            Transform InvMenuMessaging = MenuHelper.MainMenu.transform.Find("Container/MMParent/HeaderOffset/Modal_MM_InviteResponse/MenuPanel/ScrollRect/Viewport/VerticalLayoutGroup/Panel_AddPhotoPrompt/Photo_VRCPlus_Message");
            if (InvMenuMessaging != null)
            {
                InvMenuMessaging.localScale = Vector3.zero;
                InvMenuMessaging.gameObject.SetActive(false);
            }
            else HDLogger.LogError("Failed to find Photo_VRCPlus_Message");
            ...
            else HDLogger.LogError("Failed to find Panel_MM_Wallet");
            ...
            else HDLogger.LogError("Failed to find Cell_Wallet_Contents");
        ...
        private static void CreateConsole()
        {
            ...
            VRConsole.Log($"Welcome to MELEXED {APIUser.CurrentUser.displayName}!", VRConsole.LogsType.Content);
        }
        ...
        private static void RemoveLoadingBackground()
        {
            ...
            else HDLogger.LogError("Failed to find LoadingBackground");
        }
    }
}
