...
namespace LUXED.CustomUI.SelectedUserMenu
{
    internal class BotMenu
    {
        ...
        {
            BotPage = new QMMenuPage("Player Bots");

            QMSingleButton OpenMenu = new QMSingleButton(MainMenu.ClientPage, 4, 0, "Bots", BotPage.OpenMe, "Bot Options", ButtonAPI.ButtonSize.Default, UnityUtils.GetSprite("Bots"));
