...
namespace LUXED.CustomUI.SelectedUserMenu
{
    internal class AvatarMenu
    {
        ...
        {
            AvatarPage = new QMMenuPage("Player Avatar");

            QMSingleButton OpenMenu = new QMSingleButton(MainMenu.ClientPage, 2, 0, "Avatar", AvatarPage.OpenMe, "Avatar Options", ButtonAPI.ButtonSize.Default, UnityUtils.GetSprite("Avatar"));
