...
{
    internal class ExternVRCSDKBaseVRCPlayerApi_SetAvatarEyeHeightByMultiplier : IHook
    {
        public void Initialize()
        {
            EasyHooking.Patcher(typeof(ExternVRCSDKBaseVRCPlayerApi).GetMethod("__SetAvatarEyeHeightByMultiplier__SystemSingle__SystemVoid", BindingFlags.Public | BindingFlags.Instance), typeof(ExternVRCSDKBaseVRCPlayerApi_SetAvatarEyeHeightByMultiplier).GetMethod(nameof(SetManualAvatarScalingAllowed), BindingFlags.NonPublic | BindingFlags.Static));
        }
