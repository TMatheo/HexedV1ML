...
namespace LUXED.Hooking
{
    internal class ExternVRCSDKBaseVRCPlayerApi_SetAvatarEyeHeightMinimumByMeters : IHook
    {
        ...
        {
           EasyHooking.Patcher(typeof(ExternVRCSDKBaseVRCPlayerApi).GetMethod("__SetAvatarEyeHeightMinimumByMeters__SystemSingle__SystemVoid", BindingFlags.Public | BindingFlags.Instance), typeof(ExternVRCSDKBaseVRCPlayerApi_SetAvatarEyeHeightMinimumByMeters).GetMethod(nameof(SetManualAvatarScalingAllowed), BindingFlags.NonPublic | BindingFlags.Static));
        }
