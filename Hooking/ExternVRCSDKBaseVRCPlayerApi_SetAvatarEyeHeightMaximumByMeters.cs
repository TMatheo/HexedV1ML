...
namespace LUXED.Hooking
{
    internal class ExternVRCSDKBaseVRCPlayerApi_SetAvatarEyeHeightMaximumByMeters : IHook
    {
        ...
        {
            EasyHooking.Patcher(typeof(ExternVRCSDKBaseVRCPlayerApi).GetMethod("__SetAvatarEyeHeightMaximumByMeters__SystemSingle__SystemVoid", BindingFlags.Public | BindingFlags.Instance), typeof(ExternVRCSDKBaseVRCPlayerApi_SetAvatarEyeHeightMaximumByMeters).GetMethod(nameof(SetManualAvatarScalingAllowed), BindingFlags.NonPublic | BindingFlags.Static));
        }
